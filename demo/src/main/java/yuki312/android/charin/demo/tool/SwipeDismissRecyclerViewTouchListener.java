...
/*
 * Original Source: Copyright 2013 Google Inc.
...
public class SwipeDismissRecyclerViewTouchListener implements View.OnTouchListener {
     ...
     * android.support.v7.widget.RecyclerView.OnScrollListener} using {@link android.support.v7.widget.RecyclerView.OnScrollListener#setOnScrollListener(android.support.v7.widget.RecyclerView.OnScrollListener)}.
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        if (mViewWidth < 2) {
            mViewWidth = recyclerView.getWidth();
        }
        ...
        switch (motionEvent.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                recyclerView.getLocationOnScreen(recyclerViewCoords);
                int x = (int) motionEvent.getRawX() - recyclerViewCoords[0];
                int y = (int) motionEvent.getRawY() - recyclerViewCoords[1];
                View child;
                ...
                if (mDownView != null) {
                    ...
                    mDownPosition = recyclerView.getChildPosition(mDownView);
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mDismissAnimationRefCount == 0) {
                    ...
                    mCallbacks.onDismiss(recyclerView, dismissPositions);
